...
2.Implemented AI-based zero-shot email classification via Gemini API, intelligently categorizing emails into Work, Personal, and Promotions with urgency detection.
